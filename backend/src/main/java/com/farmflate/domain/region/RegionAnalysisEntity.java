...
import com.farmflate.domain.common.BaseTimeEntity;
...
public class RegionAnalysisEntity extends BaseTimeEntity {
    ...
    /**
     * Fencing token assigned by the conditional execution claim. Every worker
     * write is conditional on this value so a reclaimed stale worker cannot
     * overwrite the current worker's progress or result.
     */
