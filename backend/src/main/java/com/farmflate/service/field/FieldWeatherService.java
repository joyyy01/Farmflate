...
public class FieldWeatherService {
    ...
    public FieldWeatherDto load(FarmEntity field) {
        ...
        try {
            location = readLocation(field.getLocationJson());
        } catch (IllegalArgumentException exception) {
            return FieldWeatherDto.unavailable("FIELD_LOCATION_PAYLOAD_INVALID");
        }
    ...
    private LocationResolution readLocation(String json) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid field location payload", exception);
        }
    }
}
